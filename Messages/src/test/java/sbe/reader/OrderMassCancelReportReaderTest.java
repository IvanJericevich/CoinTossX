...
public class OrderMassCancelReportReaderTest {
    ...
    public void testRead() throws Exception {
        ...
        assertEquals("PartitionId=1SequenceNumber=1ClientOrderId=2Status=AcceptedTransactTime=10000RejectCode=InvalidCompIDOrPasswordOrderBook=Regular",sb.toString());
