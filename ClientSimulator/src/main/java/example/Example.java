...
public class Example {
    ...
    public static void main (String[] args) throws Exception {
        ...
        client.submitOrder(1, "John", 1000, 99, "Buy", "Limit", "Day", "20211230-23:00:00", 1000, 0, 0); // Buy limit order
        client.submitOrder(2, "John", 1000, 101, "Sell", "Limit", "Day", "20211230-23:00:00", 1000, 0, 0); // Sell limit order
        client.submitOrder(3, "John", 1000, 0, "Buy", "Market", "Day", "20211230-23:00:00", 1000, 0, 0); // Buy market order
        client.submitOrder(4, "John", 1000, 0, "Buy", "StopLimit", "Day", "20211230-23:00:00", 1000, 0, 0); // Stop buy limit order
        client.submitOrder(5, "John", 1000, 0, "Buy", "Stop", "Day", "20211230-23:00:00", 1000, 0, 0); // Stop buy market order
